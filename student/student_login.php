    ...
    <section>
        <div class="log_img ">
            ...
            <div class="box1 ">
                ...
                <h1 style="text-align: center; font-size: 35px; font-family: Aldrich; ">User Login Form</h1><br>
                ...
                <p style="padding-left: 33px; ">
                    ...
                    <b style="color:white; text-decoration:none;">New to the website?</b><a href="registration.php " style="color: yellow; ">Sign Up</a>
                </p>
            </div>
        </div>
    </section>
