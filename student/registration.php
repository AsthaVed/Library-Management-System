...
<body>
    <section>
        <div class="reg_img">
            ...
            <div class="box2">
                ...
                <h1 style="text-align: center; font-size: 35px; font-family: Aldrich;">User Registration Form</h1><br>
                <form name="registration" action=" " method="post">
                    <div class="registration">
                        ...
                        <input type="file" name="picture" value="upload" id="file" accept="image/*"><br>
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($count == 0) {
            mysqli_query($db, "insert into `student` values('$_POST[first]', '$_POST[last]', '$_POST[username]', '$_POST[password]', '$_POST[roll]', '$_POST[email]', '$_POST[contact]', '$_POST[picture]');");
    ?>
