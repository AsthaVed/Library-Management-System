...
<body>
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <div style="color: white; margin-left: 40px; font-size: 20px;">
            ...
            if(isset($_SESSION['login_user']))
            {
                ...
                echo "<img class='img-circle profile_img' height=120 width=120 src='images/".$_SESSION['user_pic']."'>";
                echo "<br>";
    ...
    <!-- ___________________________________request book_________________________________________ -->
    <div class="srch">
        <form action="" class="navbar-form" method="post" name="form1">
