    ...
    <div id="main">
        ...
        <div class="container">
                ...
                $c = 0;
                    if(isset($_SESSION['login_admin']))
                    {
                        $sql = "SELECT student.username,roll,books.b_id,name,authors,edition,issue,issue_book.return FROM student INNER JOIN issue_book ON student.username = issue_book.username INNER JOIN books ON issue_book.b_id = books.b_id WHERE issue_book.approve = 'Yes' order by issue_book.return ASC";
