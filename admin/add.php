...
<body>
    ...
    <div id="main">
            ...
            <div class="container">
                <h2 style="color: black; font-family: Lucida Control; text-align: center;"><b>Add New Books</b></h2>
            </div>
            <form style="text-align: center;" class="book" action="" method="post">
                ...
                <button style="width: 80px; height: 35px;" class="btn btn-primary" type="submit" name="submit">ADD</button>
            </form>
    </div>
    ...
    <?php
        if(isset($_POST['submit']))
        {
            if(isset($_SESSION['login_admin']))
            {
                mysqli_query($db,"insert into books values ('$_POST[b_id]', '$_POST[name]', '$_POST[authors]', '$_POST[edition]', '$_POST[status]', '$_POST[quantity]', '$_POST[department]');");
    ?>
            <script>
